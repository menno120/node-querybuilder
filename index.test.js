let { QueryBuilder, DatabaseConnection, reference, FULLTEXT_MODES } = require("./index");
...
try {
	...
	if (test_13.query.trim() !== test_13_expected) {
		failed("#13", highlightDifferences(test_13_expected, test_13.query.trim()));
	} else {
		passed("#13");
	}
} catch (e) {
